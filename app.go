...
func (a *App) CreateMultiVersionExam(title, schoolYear string, questionCount, optionCount int, showName bool, csvContent string) error {
if a.dbErr != nil {
return a.dbErr
}
if a.db == nil {
...
return fmt.Errorf("option count must be between 3 and 8")
}
...
if err := repository.CreateExam(a.db, &exam); err != nil {
return err
}

if csvContent != "" {
if err := csv.ImportStudentsFromCSV(a.db, csvContent, exam.ID); err != nil {
logging.GetErrorLogger().Error("Failed to import students", slog.String("error", err.Error()))
}
}
return nil
}
...
func (a *App) GetExamVersions(examID uint) (map[string]models.VersionData, error) {
if a.dbErr != nil {
return nil, a.dbErr
}
if a.db == nil {
...
return repository.GetExamVersions(a.db, examID)
}

func (a *App) UpdateVersionAnswers(examID uint, versionCode, answers string, dateTimeStr string) error {
if a.dbErr != nil {
return a.dbErr
}
dateTime, err := time.Parse("02.01.2006 15:04", dateTimeStr)
if err != nil {
dateTime, err = time.Parse("02.01.2006", dateTimeStr)
if err != nil {
return fmt.Errorf("invalid datetime format, use dd.MM.yyyy HH:mm or dd.MM.yyyy")
}
}
return repository.UpdateExamVersionAnswers(a.db, examID, versionCode, answers, dateTime)
}

func (a *App) DeleteExamVersion(examID uint, versionCode string) error {
if a.dbErr != nil {
return a.dbErr
}
return repository.DeleteExamVersion(a.db, examID, versionCode)
}
